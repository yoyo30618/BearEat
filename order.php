								...
								<table class="table table-Info table-hover table-bordered" style="text-align:center;">
									...
									<?php
										while($row_Food=mysqli_fetch_array($res_Food)){
											...
											echo "<td>".$row_Food['Mount']."</td>";
											if($row_Food['Mount']==0)
												echo "<td>此項目已售罄</td>";
											else
												echo "<td><input type='number' class='form-control' value='0' name='count".$row_Food['_ID']."'></input></td>";
											echo "</tr>";
										}	
										echo "<tr>";
											echo "<td align='right' colspan='8'>";
											echo "<input type='text' name='ordername' class='form-control' required='required' placeholder='請輸入訂購人姓名'></input>";
											echo "<br><br>";
											echo "<input type='text' name='orderphone' class='form-control' required='required' placeholder='請輸入訂購人電話'></input>";
											echo "<br><br>";
											echo "<input type='datetime-local' class='form-control' name='GetDateTime' required='required' placeholder='期望取餐時間'></input>";
											echo "<br><br>";
											echo "<button float='right' type='submit' form='OrderChange' class='btn btn-success' name='SaveLngChange'>送出預定</button>";
											echo "</td>";
										echo "</tr>";
										?>
								</table>
